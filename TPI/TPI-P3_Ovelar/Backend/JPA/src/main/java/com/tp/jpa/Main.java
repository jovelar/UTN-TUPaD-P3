        ...
        do{
            ...
            switch(opcProductos){
                    ...
                    if(!categoriaRepo.listarActivos().isEmpty()){
                        ...
                        try{
                            ...
                            if(!cat.isEmpty()){
                                ...
                                String estadoSeleccion="asd";
                                do{
                                    System.out.println("Poducto disponible? (S/N): ");
                                    estadoSeleccion=sc.nextLine().trim();
                                    if(estadoSeleccion.toUpperCase().equals("S")){
                                        estaDisponible=true;
                                    }else if(estadoSeleccion.toUpperCase().equals("N")){
                                        estaDisponible=false;
                                    }
                                }while(!estadoSeleccion.toUpperCase().equals("S")&&!estadoSeleccion.toUpperCase().equals("N"));
                ...
                case "2":
                    ...
                    try{
                        ...
                        if(!productoAModificar.isEmpty()){
                            ...
                            if(!prodAux.isEliminado()){
                                ...
                                do{
                                    try{
                                        System.out.println("ingrese el nuevo stock (actual:"+prodAux.getStock()+") [ENTER para mantener]: ");
                                        String inputStock=sc.nextLine().trim();
                                        if(inputStock.isEmpty()){
                                            nuevoStock=prodAux.getStock();
                                        }else{
                    ...
                    break;
                case "3":
                    List<Producto>productosActivo=productoRepo.listarActivos();
                    for(Producto p:productosActivo){
                        System.out.println("ID: " + p.getId()+ ",NOMBRE: " + p.getNombre()
                                + ",PRECIO: "+ p.getPrecio() + ",STOCK: " + p.getStock());
                    }
            ...
            switch(opcUsuarios){
                ...
                case "3":
                    ...
                    if(usuarioRepo.eliminarLogico(idAEliminar)==true){
                        Usuario eliminado=usuarioRepo.buscarPorId(idAEliminar).get();
                        System.out.println("El usuario "+eliminado.getNombre()+" "+eliminado.getApellido()+" ha sido dado de baja");
                    }else{
