...
public class CategoriaRepository extends BaseRepository<Categoria> {
    ...
    public List<Producto> buscarProductosPorCategoria(Long categoriaId) {
        ...
        try{
            ...
            /* Selecciona los productos que pertenecen a la categoria buscada haciendo un inner join entre productos y categoria, donde coincida el ID de categoria y el producto no este dado de baja (logica)*/
